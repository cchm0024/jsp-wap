package sample2.controller.coment;
...
/**
 * Servlet implementation class Sample2CommaentAddServlet
 */
@WebServlet("/sample2/comment/add")
public class Sample2CommaentAddServlet extends HttpServlet {
     ...
     */
    public Sample2CommaentAddServlet() {
        super();
